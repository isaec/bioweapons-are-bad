...
a roguelike in python, with tcod. I followed the tut up to part 9, and then, some months ago when it had stagnated opted to keep working on my own. This hasnt been worked on in some time but I fear ill nuke my hard drive so I wished to save my work. This repo features the following **in addition** to the content of said tutorial:
- smarter ai
